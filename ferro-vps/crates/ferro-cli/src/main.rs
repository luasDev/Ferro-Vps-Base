//! `ferro-cli`: command-line tools for building and inspecting `Ferro-VPS`
//! artifacts (assembler front-end, program loader, ...).
//!
//! Part of the `Ferro-VPS` project. This binary currently performs no work; it
//! wires up the shared error-reporting entry point
...
fn main() -> ExitCode {
    run(|| {
        ...
        log_info!(LogTarget::Cli, "ferro-cli started");
        Ok(())
    })
}
